...
parser.add_argument(
    ...
    type=str,
    default=None,
    help="path to a file with all expected cross-entropy loss thresholds per program, per sequence. This should generally point to the artifact generated by argument `generate_metrics_path`",
)
...
default_cross_entropy_threshold = float(args.cross_entropy_threshold)
